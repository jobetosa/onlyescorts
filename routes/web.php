...
use App\Http\Controllers\SitemapController2;
...
Route::get('/usuarios_publicate/{id}/fotos-descripcion', [UsuarioPublicateController::class, 'fotosDescripcion'])
    ...
    Route::post('/usuarios-publicate/eliminar-video', [UsuarioPublicateController::class, 'eliminarVideo'])->name('usuarios_publicate.eliminarVideo');
    ...
    Route::prefix('seo')->group(function () {
        ...
        Route::get('/templates-secciones', [SEOController::class, 'templatesSecciones'])
            ->name('seo.templates.secciones'); 
    ...
    Route::prefix('secciones')->group(function () {
        ...
        Route::get('/templates-secciones', [SeccionesController::class, 'templatesSecciones'])
            ->name('secciones.templates.secciones'); 

        // API para obtener datos Secciones
        Route::get('/servicios/{servicio}/secciones', [SeccionesController::class, 'getServicioSecciones'])
            ->name('api.servicios.secciones');
        Route::get('/atributos/{atributo}/secciones', [SeccionesController::class, 'getAtributoSecciones'])
            ->name('api.atributos.secciones');
        Route::get('/nacionalidades/{nacionalidad}/secciones', [SeccionesController::class, 'getNacionalidadSecciones'])
            ->name('api.nacionalidades.secciones');
        Route::get('/sectores/{sector}/secciones', [SeccionesController::class, 'getSectorSecciones'])
            ->name('api.sectores.secciones');
    
        // Nuevas rutas para obtener datos Secciones
        Route::get('/disponibilidad/secciones', [SeccionesController::class, 'getDisponibilidadSecciones'])
            ->name('api.disponibilidad.secciones');
        Route::get('/resenas/secciones', [SeccionesController::class, 'getResenasSecciones'])
            ->name('api.resenas.secciones');
        Route::get('/categorias/{categoria}/secciones', [SeccionesController::class, 'getCategoriaSecciones'])
            ->name('api.categorias.secciones');
    
        // Rutas para actualizar Secciones
        Route::post('/general/update', [SeccionesController::class, 'updateGeneralSecciones'])
            ->name('secciones.general.update');
        Route::post('/servicios/update', [SeccionesController::class, 'updateServicioSecciones'])
            ->name('secciones.servicios.update');
        Route::post('/atributos/update', [SeccionesController::class, 'updateAtributoSecciones'])
            ->name('secciones.atributos.update');
        // Corregida esta ruta
        Route::post('/nacionalidades/update', [SeccionesController::class, 'updateNacionalidadSecciones'])
            ->name('secciones.nacionalidades.update');
        Route::post('/sectores/update', [SeccionesController::class, 'updateSectorSecciones'])
            ->name('secciones.sectores.update');
        
        // Nuevas rutas para actualizar Secciones
        Route::post('/disponibilidad/update', [SeccionesController::class, 'updateDisponibilidadSecciones'])
            ->name('secciones.disponibilidad.update');
        Route::post('/resenas/update', [SeccionesController::class, 'updateResenasSecciones'])
            ->name('secciones.resenas.update');
        Route::post('/categorias/update', [SeccionesController::class, 'updateCategoriaSecciones'])
            ->name('secciones.categorias.update');
    });
...
Route::get('/escorts/{nombre}', [InicioController::class, 'showPerfil'])
    ->where('nombre', '^(?!.*[ñÑ])[a-z0-9-]+$') // Solo permitir URLs que terminen en -número y sin espacio en blanco
    ->name('perfil.show');
...
Route::get('/sitemap.xml', [SitemapController2::class, 'index']);
Route::get('/sitemap_profiles.xml', [SitemapController2::class, 'profiles']);
Route::get('/sitemap_menu.xml', [SitemapController2::class, 'menu']);
Route::get('/sitemap_blog.xml', [SitemapController2::class, 'blog']);
Route::get('/sitemap_landing.xml', [SitemapController2::class, 'landing']);