                        ...
                        <ul class="online-list">
                            ...
                            <li class="online-item-enlaces">
                                ...
                                <div class="online-info">
                                    ...
                                    <a href="{{ route('perfil.show', ['nombre' => strtolower(($usuario->fantasia)). '-' . $usuario->id]) }}" class="online-profile-button">Ver perfil</a>
                                </div>
                            </li>
                            @endforeach
                        </ul>
            ...
            <section class="volvieronyprimera-section">
                <div class="swiper-container2">
                    ...
                    <div class="swiper-wrapper" style="display: flex; gap: 0.5rem; overflow-x: auto; padding-bottom: 0.5rem;">
                        ...
                        @endphp
                        <a href="{{ route('perfil.show', ['nombre' => strtolower($usuario->fantasia) . '-' . $usuario->id]) }}" class="swiper-slide2" style="flex: 0 0 auto; margin-right: 0;">
