...
<head>
    ...
    <meta name="description" content="Publica tu perfil y llega a clientes respetuosos y solventes. No pierdas tiempo, destaca en nuestra plataforma y consigue más oportunidades.">
    <meta name="keywords" content="publicar perfil, conseguir clientes, servicios,, atraer clientes solventes, destacar en línea">
    <meta name="robots" content="index, follow">
    <link rel="canonical" href="{{ url()->current() }}">
    
    <!-- Título de la pestaña -->
    <title>OnlyEscorts | Publica tu perfil</title>
