...
<head>
    ...
    <!-- DNS Prefetch (para conexiones menos prioritarias) -->
    ...
    <style>
        .modal-backdrop.show {
            ...
            /* Removemos el backdrop oscuro predeterminado */
        }
        .modal-backdrop {
        ...
        .fm-new-visitor-modal__header[data-v-a0cd74b1] {
            align-items: center;
            display: flex;
            gap: .75rem;
        }
        .fm-new-visitor-modal__section[data-v-a0cd74b1] {
            border-width: 0;
        ...
        .fm-new-visitor-modal__button[data-v-a0cd74b1] {
            --tw-bg-opacity: 1;
            --tw-text-opacity: 1;
            align-items: center;
        ...
        .fm-new-visitor-modal a[data-v-a0cd74b1] {
            --tw-text-opacity: 1;
        ...
        .fm-new-visitor-modal__text--small[data-v-a0cd74b1] {
            --tw-text-opacity: 1;
            /* color: rgb(38 50 56 / var(--tw-text-opacity)); */
            color: #fff;
            font-size: .75rem;
        ...
        .fm-new-visitor-modal__text[data-v-a0cd74b1] {
            font-size: .875rem;
            font-weight: 400;
            line-height: 1.25rem;
            margin: 0;
        }
        .fm-new-visitor-modal__title[data-v-a0cd74b1] {
            font-size: 1rem;
            font-weight: 400;
            line-height: 1.25rem;
            margin: 0;
        ...
        @media screen and (min-width: 1024px) {
            .home-swiper .swiper-slide-active .home-card {
                margin-top: -10px;
                box-shadow: 0 8px 40px rgba(0, 0, 0, 0.2);
            }
        }
        ...
        .swiper-zonas .swiper-wrapper {
            display: flex;
        }

        .swiper-zonas .swiper-slide {
...
<body class="custom-background">
    ...
    <header style="position: fixed; top: 0; left: 0; width: 100%; background-color: #000; z-index: 1000; border-bottom: 1px solid #44444496;">
    ...
    <script>
        const numberCards = parseInt("{{ count($tarjetas) }}")
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const swiperZonas = new Swiper('.swiper-zonas', {
                ...
                slidesPerView: 1,
                spaceBetween: 10,
                initialSlide: window.innerWidth < 768 ? 1 : 0, // Start with the second item on mobile
                pagination: {
                    el: '.zonas-pagination',
                    clickable: true,
                },
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const homeSwiper = new Swiper('.home-swiper', {
                loop: true,
                slidesPerView: 3, // Esto permite que el número de slides sea dinámico
                spaceBetween: 10,
                pagination: {
                ...
                autoplay: {
                    delay: 5000, // Cambia de slide cada 3 segundos
                ...
                breakpoints: {
                    ...
                    1024: {
                        slidesPerView: (numberCards > 4) ? 4 : numberCards,
                        spaceBetween: 20,
                    },
                    1420: {
                        slidesPerView: (numberCards > 5) ? 5 : numberCards,
                        spaceBetween: 20,
                        pagination: false
                    }
                },
