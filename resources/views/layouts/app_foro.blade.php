...
<head>
    ...
    <title>{{ $metaTags->meta_title ?? 'Blog - Escorts' }}</title>
    
    <meta name="description" content="{{ $metaTags->meta_description ?? 'Descripción predeterminada' }}">
    <meta name="keywords" content="{{ $metaTags->meta_keywords ?? 'Palabras clave predeterminadas' }}">
    <meta name="robots" content="{{ $metaTags->meta_robots ?? 'index, follow' }}">
                            ...
                            .then(foros => {
                                ...
                                if (foros.length > 0) {
                                    foros.forEach(foro => {
                                        ...
                                        foroElement.href = `/foros/${foro.id}`;
...
<!-- Scripts diferidos (evitan bloqueo de renderizado) -->
