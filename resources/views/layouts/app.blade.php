...
<head>
    ...
    <title>{{ $meta->meta_title ?? 'OnlyEscorts' }}</title>
    ...
    <!-- Preconectar recursos externos -->
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://cdnjs.cloudflare.com">
    <link rel="preconnect" href="https://cdn.jsdelivr.net">

    <!-- Prefetch DNS para mejorar resolución de dominios -->
    ...
    <!-- Estilos externos con carga diferida -->
    <link href="https://cdn.jsdelivr.net/npm/nouislider/distribute/nouislider.min.css" rel="stylesheet" media="print" onload="this.media='all'">
    ...
    <script>
        (function() {
            ...
            if (url.includes('/public/')) {
                let newUrl = url.replace('/public/', '/'); // Elimina "/public/"
                window.location.replace(newUrl); // Redirección 301
            }
        })();
    </script>
</head>
<body>
    ...
    <div class="wrapper">
            ...
            <div class="inicio-container2">    
                <div class="navbar-bottom">
                    ...
                    <div class="navbar-right">
                        ...
                        <a href="{{ route('favoritos.show') }}" class="nav-link">FAVORITOS</a>
                ...
                <div class="modal-content">
                    ...
                    <form id="filterForm">
                        <div class="modal-body">
                            ...
                            <div class="filtro-nac">
                                <div class="filter-section">
                                    <p class="range-title">Nacionalidad</p>
                            ...
                            <div class="filter-section1">
                                <p class="range-title1">Servicios</p>
                            ...
                            <!-- Attributes -->
                            <div class="filter-section1">
                                <p class="range-title1">Atributos</p>
        ...
        <footer class="footer">
            <div class="custom-footer-bottom">
                <div class="custom-container">
                    <div class="custom-footer-logo">
                        <a href="{{ route('home') }}">
                            <img src="{{ asset('images/logo_XL-2.png') }}" alt="OnlyEscorts Logo" class="custom-logo-footer" loading="lazy">
                        </a>
                        <a href="{{ route('rta') }}" class="d-none d-md-block">
                            <img src="{{ asset('images/RTA-removebg-preview1.png') }}" alt="RTA" class="custom-logo-footer1" loading="lazy">
                        </a>
                    </div>
                    <div class="d-flex d-md-none flex-column justify-content-center custom-footer-text">
                        <p>OnlyEscorts es un sitio web de anuncios</p>
                        <a href="https://api.whatsapp.com/send?phone=56940416217" class="text-decoration-none text-white mb-1" target="_blank"><i class="fa fa-phone-alt"></i>&nbsp;+56 9 4041 6217</a>
                    </div>
                    <div class="separador">
                        <div id="separator-7d06229376" class="cmp-separator">
                    ...
                    <div class="custom-footer-middle">
                        <div class="custom-links">
                            <div class="custom-link-row">
                                <a href="{{ route('foro') }}">FORO ESCORTS</a>
                            ...
                            <div class="custom-link-row">
                                ...
                                <a href="{{ route('publicate.form') }}">PUBLICATE</a>
                            </div>
                        </div>
                    </div>
                    <div class="separador">
                    ...
                    <div class="d-flex flex-md-column justify-content-around custom-logos">
                        <div class="item d-block d-md-none">
                            <a href="{{ route('rta') }}">
                                <img src="{{ asset('images/RTA-removebg-preview1.png') }}" alt="RTA" class="custom-logo-footer1" loading="lazy">
                            </a>
                        </div>
                        <div class="w-100 d-none d-md-flex flex-md-column justify-content-center mb-3">
                            <a href="https://api.whatsapp.com/send?phone=56940416217" class="text-decoration-none text-white mb-1" target="_blank"><i class="fa fa-phone-alt"></i>&nbsp;+56 9 4041 6217</a>
                        </div>
                        <div class="custom-social-links">
                            <a href="https://www.instagram.com/masajes.manquehue/" target="_blank"><img src="{{ asset('images/instagram.svg') }}" alt="Instagram" class="custom-social-icon" loading="lazy"></a>
                            <a href="#"><img src="{{ asset('images/telegram.svg') }}" alt="Telegram" class="custom-social-icon" loading="lazy"></a>
                            <a href="https://x.com/OnlyEscorts_CL" target="_blank"><img src="{{ asset('images/x.svg') }}" alt="X" class="custom-social-icon" loading="lazy"></a>
                            <a href="#"><img src="{{ asset('images/YouTube1.svg') }}" alt="Youtube" class="custom-social-icon" loading="lazy"></a>
                        </div>
                    </div>
                    <div class="separador">
                        <div id="separator-7d06229376" class="cmp-separator">
                            <hr class="cmp-separator__horizontal-rule final">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="footer-info">
                <p>© {{ date('Y') }} Only Escorts | Todos los derechos reservados</p>
            </div>
        </footer>
    </div>
    <!-- jQuery (Necesario para Magnific Popup) -->
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    <!-- Scripts (mover al final del <body> para mejorar rendimiento) -->
    <script defer src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.29.1/moment.min.js"></script>
    <script defer src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.29.1/locale/es.js"></script>
    <script defer src="https://cdnjs.cloudflare.com/ajax/libs/Swiper/9.3.2/swiper-bundle.min.js"></script>
    <script defer src="https://cdn.jsdelivr.net/npm/nouislider/distribute/nouislider.min.js"></script>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function initializeEventListeners() {
                ...
                // Boton Ver Historias
                // Capturar el botón "Ver todas" y asignarle el evento
                const verTodasBtn = document.getElementById('ver-todas-historias');
                if (verTodasBtn) {
                    verTodasBtn.addEventListener('click', abrirPrimeraHistoria);
                }
            }
            ...
            function mostrarHistorias(estado, userId) {
                ...
                const usuarioPicture = document.getElementById('modal-usuario-picture');
                ...
                fetch(`/usuario/${currentHistorias[0].usuarios_publicate_id}`)
                    ...
                    .then(usuario => {
                        ...
                        if (profileImage) {
                            if (usuario.foto) {
                                ...
                                profileImage.onerror = () => {
                                    ...
                                    profileImage.src = 'storage/profile_photos/default-avatar.jpg';
                                };
                            } else {
                                profileImage.src = 'storage/profile_photos/default-avatar.jpg';
                            }
                        ...
                        if(usuarioPicture) {
                            usuarioPicture.href = `/escorts/${usuario.fantasia.toLowerCase()}-${usuario.id}`;

                            usuarioPicture.onmouseover = function() {
                                this.style.cursor = 'pointer';
                            };
                            usuarioPicture.onmouseout = function() {
                        ...
                        if (usuarioNombre) {
                            ...
                            usuarioNombre.href = `/escorts/${usuario.fantasia.toLowerCase()}-${usuario.id}`;
            ...
            function mostrarVideo(contenido, videoPath, estado) {
                // Detener y reiniciar el video anterior si existe
                if (currentVideo) {
                    currentVideo.pause();
                ...
                video.controls = false; // 🔹 Evita que el usuario active pantalla completa
                video.autoplay = true;
                video.playsInline = true; // 🔹 Evita que se abra en pantalla completa en iPhone
                video.style.maxWidth = '100%';
                video.style.maxHeight = '100vh';
                video.style.objectFit = 'contain';

                // Asegurar que la ruta del video es válida
                ...
                let extension = videoPath.split('.').pop().toLowerCase();
                let mimeTypes = {
                    mp4: 'video/mp4',
                    m4v: 'video/x-m4v',
                    mov: 'video/quicktime',
                ...
                source.type = mimeTypes[extension] || 'video/mp4'; // Si no se reconoce, usar mp4 por defecto

                video.appendChild(source);
                contenido.appendChild(video);

                // Asignar como el video actual
                currentVideo = video;
                ...
                video.onerror = () => {
                    ...
                    setTimeout(nextHistoria, 3000); // Avanzar a la siguiente historia tras 3s
                };

                // 🔹 Intentar reproducir con sonido
                video.play().catch(error => {
                    console.log('⚠️ Safari bloqueó el autoplay con sonido.');

                    // 🔹 Si el navegador lo bloquea, activamos mute y lo reproducimos
                    video.muted = true;
                    video.play().then(() => {
                        // 🔹 Intentar activar sonido tras unos segundos
                        setTimeout(() => {
                            video.muted = false; // 🔥 Reactivar sonido después
                        }, 1000);
                    });
                });

                // 🔹 Permitir sonido con un toque del usuario (iOS requiere interacción manual)
                document.addEventListener('click', () => {
                    video.muted = false;
                    video.play();
                }, { once: true });

                // 🔹 Bloquear menú contextual (clic derecho) para evitar que se activen controles
            ...
            function nextHistoria() {
                ...
                // Obtener la lista de historias
                const historiaItems = Array.from(document.querySelectorAll('.historia-item'));
                const currentItem = historiaItems.find(item => item.dataset.usuarioId == currentUserId);

                if (!currentItem) return;

                const currentIndexInList = parseInt(currentItem.dataset.index);

                // Si estamos en la última historia del último usuario, cerrar modal
                if (currentIndexInList === historiaItems.length - 1 && currentIndex === currentHistorias.length - 1) {
                    console.log("No hay más historias, cerrando modal.");
                    cerrarHistoria();
                    return;
                }

                // Si hay más historias dentro del usuario actual, avanzar
                if (currentIndex < currentHistorias.length - 1) {
                    currentIndex++;
                    mostrarHistoriaActual();
                } else {
                    // Avanzar al siguiente usuario en la lista
                    const nextItem = historiaItems[currentIndexInList + 1];
                    if (nextItem) {
                        const estados = JSON.parse(nextItem.dataset.estados);
                        const usuarioId = nextItem.dataset.usuarioId;
                        mostrarHistorias(estados, usuarioId);
                    }
                }
            }

            function avanzarAlSiguienteUsuario() {
                const historiaItems = Array.from(document.querySelectorAll('.historia-item'));
                const currentItem = historiaItems.find(item => item.dataset.usuarioId == currentUserId);
                ...
                const currentIndexInList = historiaItems.indexOf(currentItem);
                
                if (currentIndexInList === -1 || currentIndexInList === historiaItems.length - 1) {
                    // Si ya no hay más historias, cerrar modal automáticamente
                    cerrarHistoria();
                } else {
                    // Obtener el siguiente usuario en la lista y mostrar sus historias
                    const nextItem = historiaItems[currentIndexInList + 1];
                    const estados = JSON.parse(nextItem.dataset.estados);
                    const usuarioId = nextItem.dataset.usuarioId;
            ...
            function previousHistoria() {
                ...
                // Obtener el índice actual del usuario
                const historiaItems = Array.from(document.querySelectorAll('.historia-item'));
                const currentItem = historiaItems.find(item => item.dataset.usuarioId == currentUserId);
                ...
                // Si ya estamos en la primera historia de la lista, detener la navegación
                if (currentIndexInList === 0 && currentIndex === 0) {
                    console.log("Ya estás en la primera historia, no puedes retroceder más.");
                    return;
                }

                // Si hay historias previas dentro del usuario actual, retrocede
                if (currentIndex > 0) {
                    currentIndex--;
                    mostrarHistoriaActual();
                } else {
                    // Buscar el usuario anterior si ya llegamos al inicio de las historias del usuario actual
                    const prevItem = historiaItems[currentIndexInList - 1];
                    if (prevItem) {
                        const estados = JSON.parse(prevItem.dataset.estados);
                        const usuarioId = prevItem.dataset.usuarioId;
                        mostrarHistorias(estados, usuarioId);
                    }
                }
            }

            function retrocederAlUsuarioAnterior() {
                const historiaItems = Array.from(document.querySelectorAll('.historia-item'));
                const currentItem = historiaItems.find(item => item.dataset.usuarioId == currentUserId);

                if (!currentItem) {
                    return false; // No hacer nada si no hay usuario actual válido
                }

                const currentIndexInList = historiaItems.indexOf(currentItem);

                if (currentIndexInList === 0) {
                    // Si ya estamos en la primera historia del primer usuario, detener el retroceso
                    return false;
                } else {
                    // Obtener el usuario anterior en la lista y mostrar sus historias
                    const prevItem = historiaItems[currentIndexInList - 1];
                    const estados = JSON.parse(prevItem.dataset.estados);
                    const usuarioId = prevItem.dataset.usuarioId;
            ...
            function abrirPrimeraHistoria() {
                const historiaItems = Array.from(document.querySelectorAll('.historia-item'));

                if (historiaItems.length > 0) {
                    // Obtener el primer item de la lista de historias
                    const primeraHistoria = historiaItems[0];
                    const estados = JSON.parse(primeraHistoria.dataset.estados);
                    const usuarioId = primeraHistoria.dataset.usuarioId;

                    // Mostrar las historias del primer usuario
                    mostrarHistorias(estados, usuarioId);
                } else {
                    console.log("No hay historias disponibles.");
                }
            }
    ...
    @if(Route::currentRouteName() !== 'inicio' && Route::currentRouteName() !== 'favoritos.show')
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                function initMap() {
                    // Obtener todos los elementos con la clase "escort-map"
                    const mapElements = document.querySelectorAll('.escort-map');
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                const videoElement = document.querySelector(".escortperfil-video");
                const bullets = document.querySelectorAll(".escortperfil-section .swiper-pagination-bullet");
                const prevButton = document.querySelector(".escortperfil-section .swiper-button-prev");
                const nextButton = document.querySelector(".escortperfil-section .swiper-button-next");

                let currentIndex = 0;

                function updateVideo(newIndex) {
                    console.log(newIndex)
                    // Validar límites: No permitir avanzar más del último ni retroceder antes del primero
                    if (newIndex < 0 || newIndex >= bullets.length) return;

                    currentIndex = newIndex;

                    // Obtener el nuevo src del data-video
                    const newVideoSrc = bullets[currentIndex].getAttribute("data-video");
                    ...
                    if (newVideoSrc) {
                        ...
                        // Actualizar la clase activa en la paginación
                        document.querySelector(".escortperfil-section .swiper-pagination-bullet-active")?.classList.remove("swiper-pagination-bullet-active");
                        bullets[currentIndex].classList.add("swiper-pagination-bullet-active");

                        // Deshabilitar botones si es necesario
                        prevButton.disabled = currentIndex === 0;
                        nextButton.disabled = currentIndex === bullets.length - 1;
                    }
                }

                // Event listeners SOLO para los botones Prev y Next
                prevButton.addEventListener("click", () => updateVideo(currentIndex - 1));
                nextButton.addEventListener("click", () => updateVideo(currentIndex + 1));

                // Inicializar estado de botones
                prevButton.disabled = currentIndex === 0;
                nextButton.disabled = currentIndex === bullets.length - 1;

                let videos = document.querySelectorAll(".escortperfil-video");

                videos.forEach(video => {
                    // Capturar tanto click como touchstart para compatibilidad con iOS Safari
                    video.addEventListener("click", togglePlayPause);
                    video.addEventListener("touchstart", togglePlayPause); 

                    function togglePlayPause(event) {
                        event.preventDefault(); // Evitar comportamientos no deseados en Safari iOS
                        ...
                        // Alternar entre reproducir y pausar el video actual
                        if (video.paused) {
                            video.play();
                        } else {
                            video.pause();
    ...
    <script>
        ...
        function setButtonState(button, isFavorited) {
            const textSpan = button.querySelector('.text-wrapper');
            const heartIcon = button.querySelector('.share-icon');
            ...
            if (isFavorited) {
                ...
                heartIcon.style.background = '#e00037';
            } else {
