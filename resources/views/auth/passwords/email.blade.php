...
@section('title', 'OnlyEscorts | Recuperar Contraseña')

@section('description', 'Recupera el acceso a tu cuenta de forma segura. Restablece tu contraseña en pocos pasos y sigue aprovechando nuestros servicios sin inconvenientes.')
...
@section('content')
    <div class="login-container">
        ...
        <div class="logo-title-container">
            ...
            <h1 class="title" hidden>Recuperar</h1>
