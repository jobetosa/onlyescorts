...
@section('title', 'OnlyEscorts | Register')

@section('description', 'Únete a nuestra plataforma y accede a nuestras herramientas. Regístrate en pocos pasos y empieza hoy.')
...
@section('content')
    <div class="login-container">
        ...
        <div class="logo-title-container">
            ...
            <h1 class="title" hidden>Registro</h1>
        ...
        <div class="login-box">
            ...
            <div class="register-link">
                <p>
                    ...
                    <br>
                    <a href="{{ route('login') }}" class="register-now">Iniciar Sesión</a>
                </p>
            </div>
        </div>
    </div>
