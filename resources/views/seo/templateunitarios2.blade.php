        ...
        <div class="card-body">
            <div class="tab-content" id="seccionesTabsContent">
                 ...
                 <div class="tab-pane fade show active" id="general" role="tabpanel">
                    ...
                    <form action="{{ route('secciones.general.update') }}" method="POST" id="generalForm">
                        @csrf
                        <input type="hidden" name="ciudad_id" class="ciudad-input">
                       
                        @include('admin.partials.secciones-fields', ['prefix' => 'general'])
                ...
                <div class="tab-pane fade" id="servicios" role="tabpanel">
                    ...
                    <form action="{{ route('secciones.servicios.update') }}" method="POST" id="servicioForm">
                        @csrf
                        <input type="hidden" name="servicio_id" id="servicio_id_input">
                        <input type="hidden" name="ciudad_id" class="ciudad-input">
                       
                        @include('admin.partials.secciones-fields', ['prefix' => 'servicio'])
                ...
                <div class="tab-pane fade" id="atributos" role="tabpanel">
                    ...
                    <form action="{{ route('secciones.atributos.update') }}" method="POST" id="atributoForm">
                        @csrf
                        <input type="hidden" name="atributo_id" id="atributo_id_input">
                        <input type="hidden" name="ciudad_id" class="ciudad-input">

                        @include('admin.partials.secciones-fields', ['prefix' => 'atributo'])
                    </form>
                </div>
                ...
                <div class="tab-pane fade" id="nacionalidades" role="tabpanel">
                    ...
                    <form action="{{ route('secciones.nacionalidades.update') }}" method="POST" id="nacionalidadForm">
                        @csrf
                        <input type="hidden" name="nacionalidad_id" id="nacionalidad_id_input">
                        <input type="hidden" name="ciudad_id" class="ciudad-input">

                        @include('admin.partials.secciones-fields', ['prefix' => 'nacionalidad'])
                    </form>
                </div>
                ...
                <div class="tab-pane fade" id="sectores" role="tabpanel">
                    ...
                    <form action="{{ route('secciones.sectores.update') }}" method="POST" id="sectorForm">
                        @csrf
                        <input type="hidden" name="sector_id" id="sector_id_input">
                        <input type="hidden" name="ciudad_id" class="ciudad-input">

                        @include('admin.partials.secciones-fields', ['prefix' => 'sector'])
                    </form>
                </div>

                <!-- Tab Disponibilidad -->
                <div class="tab-pane fade" id="disponibilidad" role="tabpanel">
                    <form action="{{ route('secciones.disponibilidad.update') }}" method="POST" id="disponibilidadForm">
                        @csrf
                        <input type="hidden" name="ciudad_id" class="ciudad-input">

                        @include('admin.partials.secciones-fields', ['prefix' => 'disponibilidad'])
                    </form>
                </div>

                <!-- Tab Reseñas -->
                <div class="tab-pane fade" id="resenas" role="tabpanel">
                    <form action="{{ route('secciones.resenas.update') }}" method="POST" id="resenasForm">
                        @csrf
                        <input type="hidden" name="ciudad_id" class="ciudad-input">

                        @include('admin.partials.secciones-fields', ['prefix' => 'resenas'])
                    </form>
                </div>
                ...
                <div class="tab-pane fade" id="categorias" role="tabpanel">
                    ...
                    <form action="{{ route('secciones.categorias.update') }}" method="POST" id="categoriaForm">
                        @csrf
                        <input type="hidden" name="categoria_id" id="categoria_id_input">
                        <input type="hidden" name="ciudad_id" class="ciudad-input">

                        @include('admin.partials.secciones-fields', ['prefix' => 'categoria'])
                    </form>
                </div>
            </div>
        </div>
