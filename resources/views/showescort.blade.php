    ...
    <div class="escortperfil-container">
        <header class="escortperfil-banner">
            <div class="escortperfil-swiper">
                    ...
                    @foreach($fotos as $foto)
                        <div class="escortperfil-swiper-slide swiper-slide">
                            ...
                            @else                        
                                ...
                                <a href="{{ asset("storage/chicas/{$usuarioPublicate->id}/{$foto}") }}" class="gallery-item">
                                    <img src="{{ asset("storage/chicas/{$usuarioPublicate->id}/{$foto}") }}" alt="{{ $descripcionFoto }}" class="escortperfil-banner-img">
                                </a>
                            @endif
                        </div>
                    @endforeach
                ...
                <div class="escortperfil-swiper-button-prev carousel-control prev"><i class="fa fa-caret-left"></i></div>
                <div class="escortperfil-swiper-button-next carousel-control next"><i class="fa fa-caret-right"></i></div>
                <!-- Paginación -->
                <div class="escortperfil-swiper-pagination carousel-indicators"></div>
            </div>

            <div class="container">
                <div class="escortperfil-box-info">
                    <h1 class="escortperfil-nombre">
                        {{ $usuarioPublicate->fantasia }}
                        @php
                            $now = now();
                    ...
                    <h2 class="escortperfil-nombrechikito">
        ...
        <div class="col-md-3 redes-sociales">
            <div class="row">
                <button class="favorito {{ $usuarioPublicate->isFavoritedByUser(auth()->id()) ? 'active' : '' }}"
                    data-id="{{ $usuarioPublicate->id }}">
                    <div class="icon-wrapper" style="padding-bottom: 5px;">
                        <img src="/images/love.svg" alt="Share icon" class="share-icon">
                    </div>
                ...
                <button class="compartir" onclick="openShareModal()">
                    <div class="icon-wrapper" style="padding-bottom: 5px;">
                        <img src="/images/share.svg" alt="Share icon" class="share-icon">
                    </div>
                    <div class="text-wrapper">
                        COMPARTIR
                    </div>
        ...
        <div class="escortperfil-info-bar">
            <div class="escortperfil-info-item">
                <img src="{{ asset('images/world.svg') }}" alt="Nacionalidad" class="escortperfil-info-icon">
            ...
            <div class="escortperfil-info-item">
                <img src="{{ asset('images/birthday.svg') }}" alt="Edad" class="escortperfil-info-icon">
                <div class="escortperfil-info-text">
            ...
            <div class="escortperfil-info-item">
                <img src="{{ asset('images/money.svg') }}" alt="Precio" class="escortperfil-info-icon">
                <div class="escortperfil-info-text">
                    ...
                    @else
                        <a href="https://api.whatsapp.com/send?phone={{ $usuarioPublicate->telefono }}&text=Hola%20{{ $usuarioPublicate->fantasia }}!%20Vi%20tu%20anuncio%20en%20OnlyEscorts%20y%20me%20gustar%C3%ADa%20saber%20m%C3%A1s%20sobre%20tus%20servicios.%20%C2%BFC%C3%B3mo%20est%C3%A1s?"
                            target="_blank"
            ...
            <div class="escortperfil-info-item">
                <img src="{{ asset('images/maps.svg') }}" alt="Ubicación" class="escortperfil-info-icon">
                <div class="escortperfil-info-text">
            ...
            <div class="escortperfil-content">
                <div class="escortperfil-section">
                    ...
                    <p class="escortperfil-description-text">
                        @if(strlen($usuarioPublicate->cuentanos) > 280)
                            <span id="texto-corto">{{ Str::limit($usuarioPublicate->cuentanos, 280) }}</span>
