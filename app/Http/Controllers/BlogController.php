...
class BlogController extends Controller
{
    public function showBlog()
    {
        ...
        $meta->meta_title = 'OnlyEscorts | Blog';
    ...
    public function show_article($slug)
    {
        ...
        $articulo = BlogArticle::with(['categories', 'tags'])->where('slug', $slug)->first();

        //validate if not exists redirect to 301
        if (empty($articulo)) {
        ...
        $meta->meta_title = 'OnlyEscorts | ' . $articulo->titulo;
    ...
    public function showCategory($slug)
    {
        ...
        $meta->meta_title = 'OnlyEscorts | Blog -' . $categoria->nombre;
        $meta->meta_description = $categoria->descripcion;
        $meta->canonical_url = url()->current();
