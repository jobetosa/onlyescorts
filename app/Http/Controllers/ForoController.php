...
class ForoController extends Controller
{
    public function showForo()
    {
        ...
        $metaTags->meta_title = 'OnlyEscorts | Foro Escorts';
        ...
        return view('foro', [
            ...
            'sectores' => $sectores,
            'metaTags' => $metaTags, // Pasar el objeto meta para usar en el head
        ]);
    }
    ...
    public function show_foro($categoria)
    {
        ...
        if (!isset($categorias[$categoria])) {            
            return redirect()->route('foro', [], 301);            
        }
        ...
        $metaTags->meta_title = 'OnlyEscorts | Foro - ' . $categoriaActual->titulo;
        $metaTags->meta_description = $categoriaActual->titulo;
