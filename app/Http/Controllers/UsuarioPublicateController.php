    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            $request->validate([
                ...
                'fotos.*' => 'nullable|image|mimes:jpeg,png,jpg,gif,webp,avif|max:3064',
                'foto_destacada' => 'nullable|file|mimes:jpeg,png,jpg,gif,webp,avif|max:3064',
                'videos.*' => 'nullable|file|mimetypes:video/mp4,video/x-m4v,video/webm,video/ogg|max:7168',
                ...
                'u1' => 'nullable|string|max:250',
                'u2' => 'nullable|string|max:250',
                'sectores' => 'nullable|exists:sectores,id',
            ]);
            ...
            try {
                ...
                if (strpos($telefono, '+56') !== 0) {
                    $telefono = '+56' . preg_replace('/\s+/', '', $telefono);
                } else {
