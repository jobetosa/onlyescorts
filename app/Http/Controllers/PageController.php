...
class PageController extends Controller
{
    public function contacto()
    {
        ...
        $meta = new stdClass();
        $meta->meta_title = 'OnlyEscorts | Contacto';
        $meta->meta_description = 'Tienes dudas o necesitas ayuda? Contáctanos ahora y nuestro equipo responderá lo antes posible. ¡Tu consulta es importante para nosotros!';
        $meta->meta_keywords = 'onlyescorts, escorts, contacto, dudas, ayuda';
